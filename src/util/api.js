...
export const fetchEmailSubscriptions = () => {
  return request('/api/mailchimp/tags', { method: methods.GET });
};

export const updateEmailSubscription = (body) => {
  return post('/api/mailchimp/tag', body);
};
